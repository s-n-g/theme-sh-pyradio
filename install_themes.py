...
parser = ArgumentParser(description='Install PyRadio theme.sh themes')
...
if args.all or args.default or \
    ...
    if args.uninstall:
        print('PyRadio theme.sh themes uninstalled!\n')
    else:
        print('PyRadio theme.sh themes installed!\n')
    ...
    if args.uninstall:
        scr.addstr(0, 0, 'Uninstalling PyRadio theme.sh themes', curses.color_pair(0))
    else:
        scr.addstr(0, 0, 'Installing PyRadio theme.sh themes', curses.color_pair(0))
